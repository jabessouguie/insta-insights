...
const FR = {
  ...
  "guide.subtitle": "Importe du texte et des photos pour créer un guide professionnel",
  "guide.type.label": "Type de guide",
  "guide.type.travel": "Voyage",
  "guide.type.tutorial": "Tutoriel",
  "guide.type.recipe": "Recette",
  "guide.type.tips": "Conseils",
  "guide.type.general": "Général",
  "guide.title.label": "Titre du guide",
  "guide.title.placeholder": "Mon guide de voyage à Paris...",
  "guide.subtitle.label": "Sous-titre (optionnel)",
  "guide.subtitle.placeholder": "Tout ce qu'il faut savoir avant de partir",
  "guide.author.label": "Ton nom / marque",
  "guide.author.placeholder": "@toncompte",
  "guide.color.label": "Couleur principale",
  "guide.sections.title": "Sections",
  "guide.sections.add": "Ajouter une section",
  "guide.sections.placeholder": "Décris le contenu de cette section...",
  "guide.sections.section": "Section",
  "guide.photos.title": "Photos (optionnel)",
  "guide.photos.description": "Jusqu'à 8 photos · JPG, PNG, WebP · Photos Mac, dossiers...",
  "guide.photos.dropzone": "Clique ou glisse tes photos ici",
  "guide.generate": "Générer le guide",
  "guide.generating": "Génération en cours...",
  "guide.export": "Exporter en PDF",
  "guide.preview.empty": "L'aperçu de ton guide apparaîtra ici",
  "guide.error.noTitle": "Ajoute un titre à ton guide",
  "guide.error.noSection": "Ajoute au moins une section",
  ...
  "carousel.photos.description": "Jusqu'à 20 photos · formats JPG, PNG, WebP",
  "carousel.photos.dropzone": "Clique ou glisse tes photos ici (Photos Mac, dossiers...)",
  "carousel.photos.cover": "Mettre en couverture",
...
const EN: Record<keyof typeof FR, string> = {
  ...
  "guide.subtitle": "Import text and photos to create a professional guide",
  "guide.type.label": "Guide type",
  "guide.type.travel": "Travel",
  "guide.type.tutorial": "Tutorial",
  "guide.type.recipe": "Recipe",
  "guide.type.tips": "Tips",
  "guide.type.general": "General",
  "guide.title.label": "Guide title",
  "guide.title.placeholder": "My travel guide to Paris...",
  "guide.subtitle.label": "Subtitle (optional)",
  "guide.subtitle.placeholder": "Everything you need to know before you go",
  "guide.author.label": "Your name / brand",
  "guide.author.placeholder": "@youraccount",
  "guide.color.label": "Accent colour",
  "guide.sections.title": "Sections",
  "guide.sections.add": "Add a section",
  "guide.sections.placeholder": "Describe this section's content...",
  "guide.sections.section": "Section",
  "guide.photos.title": "Photos (optional)",
  "guide.photos.description": "Up to 8 photos · JPG, PNG, WebP · Mac Photos, folders...",
  "guide.photos.dropzone": "Click or drag your photos here",
  "guide.generate": "Generate guide",
  "guide.generating": "Generating...",
  "guide.export": "Export as PDF",
  "guide.preview.empty": "Your guide preview will appear here",
  "guide.error.noTitle": "Add a title to your guide",
  "guide.error.noSection": "Add at least one section",
  ...
  "carousel.photos.title": "2. Photos",
  "carousel.photos.description": "Up to 20 photos · JPG, PNG, WebP formats",
  "carousel.photos.dropzone": "Click or drag your photos here (Mac Photos, folders...)",
  "carousel.photos.cover": "Set as cover",
